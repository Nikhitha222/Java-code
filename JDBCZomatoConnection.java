...
public class JDBCZomatoConnection {
	...
	private static void deleteRestaurantName(Connection connection,int restaurantId)throws SQLException {
	...
	private static void viewRestaurantName(Connection connection,int Id) throws SQLException {
	...
	public static void main(String []args)throws Exception {
		...
		switch(choice) {
			...
			case 2:
				...
				updateRestaurantName(connection,100);

				break;	

			case 3:
				deleteRestaurantName(connection,100);
				break;	

			case 4:
				viewRestaurantName(connection,20);
				break;	
